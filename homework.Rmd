...
1. Map the locations of accidents based on the lat/long and use the United
   ...
   the folder 'Data/US'). Please note the `accident.dbf` can be loaded by
   the following codes, and there are invalid values for lat/long column
   that you probably need to clean up before use.  
